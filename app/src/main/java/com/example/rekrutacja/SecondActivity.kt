    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            firstButton.setOnClickListener {
                ...
                else Toast.makeText(applicationContext, "Obrazek jest już niewodoczny", Toast.LENGTH_LONG).show()
            }
            secondButton.setOnClickListener {
                ...
                else Toast.makeText(applicationContext, "Obrazek jest już widoczny", Toast.LENGTH_LONG).show()
            }
